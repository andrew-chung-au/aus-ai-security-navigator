...
10. Build the PostgreSQL retrieval index (including full-text and pgvector columns).
11. Run text, vector, and hybrid retrieval plus retrieval evaluation.
...
- comparative retrieval evaluation over the synthetic question set (text, vector, hybrid)
